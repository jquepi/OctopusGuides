...
export CUCUMBER_TAGS="(not @browserspecific or @firefox) and (not @destinationspecific or @k8s) and (not @repositoryspecific or @dockerhub) and (not @applicationspecific or @java) and (not @sourcespecific or @git)"
