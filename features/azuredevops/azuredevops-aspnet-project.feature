Feature: Build and deploy a ASP.NET application hosted in Git on a local Octopus instance
  ...
  Scenario: Configure project
    ...
    And I populate the "Path to vstest.console.exe" text box with "packages\Microsoft.TestPlatform.16.3.0\tools\net451\Common7\IDE\Extensions\TestPlatform\vstest.console.exe"
    ...
    And I save a screenshot to "s3://i.octopus.com/guides/azuredevops/initialproject/165-build-link.png"
