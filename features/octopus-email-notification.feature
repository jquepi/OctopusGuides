Feature: Add a manual intervention step
  ...
  Scenario: Add the notification step
    ...
    And I save a screenshot to "C:\screenshots\octopus\email\005-random-quotes-project.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\email\010-add-step.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\email\015-octopus-search-email.png"
    ...
    And I save a screenshot to "C:\screenshots\octopus\email\020-octopus-add-email.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\email\025-octopus-step-name.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\email\030-octopus-step-to.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\email\035-octopus-step-subject.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\email\040-octopus-step-body.png"
