Feature: Build and deploy a ASP.NET application hosted in Git on a local Octopus instance
  ...
  Scenario: Install plugins
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}05-manage-jenkins.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}10-manage-plugins.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}15-msbuild-plugin.png"
    And I click the "Install without restart" button
    And I wait for "5" seconds

    And I highlight outside the "Back to top" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}20-plugin-install.png"
    # fake a click
  ...
  Scenario: Configure tools
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}25-global-tool-configuration.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}30-msbuild-global-tool.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}35-msbuild-settings.png"
  ...
  Scenario: Configure credentials
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}40-configure-credentials.png"
    And I click the "Configure Credentials" link

    And I highlight inside the "Credentials" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}45-credentials-parent.png"
    And I click the "Credentials" link

    And I highlight inside the "System" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}50-credentials-system.png"
    And I click the "System" link

    And I highlight outside the "Global credentials cell" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}55-global-credentials.png"
    And I click the "Global credentials" link

    And I highlight inside the "Add Credentials" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}60-add-credentials.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}65-octopus-credentials.png"
  ...
  Scenario: Prepare the project
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}75-new-item.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}80-freestyle-project.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}00-secret-text.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}05-credentials-octopusapikey.png"
  ...
  Scenario: ASP.NET - Create the project
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}10-batch-command-1.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}15-nuget-restore.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}20-msbuild-step-add.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}25-msbuild-step.png"
    ...
    And I click the "Add build step" button
    And I highlight outside the "Execute Windows batch command" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}27-batch-command-2.png"
    And I click the "Execute Windows batch command" link
    And I remove the highlight from the "Add build step" option
    And I remove the highlight from the "Execute Windows batch command" option
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}28-nunit-test.png"
  ...
  Scenario: ASP.NET - Add Artifactory Push Step
    ...
    And I click the "Add build step" button
    And I highlight outside the "Execute Windows batch command" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}30-artifactory-batch-command-1.png"
    And I click the "Execute Windows batch command" link
    And I remove the highlight from the "Add build step" option
    And I remove the highlight from the "Execute Windows batch command" option
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}35-nuget-push.png"
  ...
  Scenario: ASP.NET - Add Octopus Push Step
    ...
    And I click the "Add build step" button
    And I highlight outside the "Execute Windows batch command" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}30-batch-command-3.png"
    And I click the "Execute Windows batch command" link
    And I remove the highlight from the "Add build step" option
    And I remove the highlight from the "Execute Windows batch command" option
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}35-octo-push.png"
  ...
  Scenario: ASP.NET Core - Create the project
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject\#{GuideSpecificScreenshotDir}010-dotnet-test.png"
    And I remove the highlight from the "Command" text box
    ...
    And I click the "Add build step" button
    And I highlight outside the "Execute Windows batch command" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject\#{GuideSpecificScreenshotDir}020-batch-command-2.png"
    And I click the "Execute Windows batch command" link
    And I remove the highlight from the "Add build step" option
    And I remove the highlight from the "Execute Windows batch command" option
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject\#{GuideSpecificScreenshotDir}030-dotnet-publish.png"
    And I remove the highlight from the "Command Two" text box
    ...
    And I click the "Add build step" button
    And I highlight outside the "Execute Windows batch command" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject\#{GuideSpecificScreenshotDir}040-batch-command-3.png"
    And I click the "Execute Windows batch command" link
    And I remove the highlight from the "Add build step" option
    And I remove the highlight from the "Execute Windows batch command" option
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject\#{GuideSpecificScreenshotDir}060-octo-pack.png"
    And I remove the highlight from the "Command Three" text box
  ...
  Scenario: ASP.NET Core - Add Artifactory Push Step
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject\#{GuideSpecificScreenshotDir}070-nuget-push.png"
  ...
  Scenario: ASP.NET Core - Add Octopus Push Step
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject\#{GuideSpecificScreenshotDir}070-octo-push.png"
  ...
  Scenario: Run build
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}40-build-now.png"
    And I click the "Build Now" link

    And I highlight inside the "Build One" link
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}45-build-one.png"
    ...
    And I save a screenshot to "c:\screenshots\jenkins\initialproject#\{GuideSpecificScreenshotDir}50-console.png"
