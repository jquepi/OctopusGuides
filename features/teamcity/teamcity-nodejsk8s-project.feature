Feature: Create Docker project
  ...
  Scenario: Create Project
    ...
    And I populate the "Step name" text box with "PHPUnit Test"
...
#    """
    ...
    And I highlight outside the "Save" button
    And I populate the "Image name:tag" text box with "octopussamples/randomquotesjs:1.0.%build.counter%"
