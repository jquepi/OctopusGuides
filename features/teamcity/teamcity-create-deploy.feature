Feature: Create and deploy a release
  ...
  Scenario: Add step
    ...
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}001-create-release.png"
    And I click the "Build" link

    And I highlight outside the "Edit Configuration Settings" link
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}002-create-release.png"
    And I click the "Edit Configuration Settings" link

    And I highlight outside the "Build Steps" link
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}003-create-release.png"
    And I click the "Build Steps" link

    And I highlight outside the "Add build step" button
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}004-create-release.png"
    ...
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}010-create-release.png"

    And I scroll the "Step name" text box into view offset by "-300"
    And I highlight outside the "Step name" text box
    And I populate the "Step name" text box with "Create and deploy release"
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}020-create-release.png"
    ...
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}030-create-release.png"
    ...
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}060-create-release.png"
    And I remove the highlight from the "Octopus Environments" text box

    And I scroll the "Save" button into view
    And I highlight outside the "Save" button
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}070-create-release.png"
  ...
  Scenario: Run a build
    ...
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}080-build-config-home.png"
    And I click the "Build Configuration Home" link

    And I highlight outside the "Run" button
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}090-run.png"
    And I click the "Run" button
    And I sleep for "10" seconds
    And I refresh the page

    And I highlight outside the "Build Two" link
    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}100-build-one.png"
    And I click the "Build Two" link
    And I click the "Build log" link
    And I scroll down "10000" px
    And I sleep for "30" seconds

    And I save a screenshot to "c:\screenshots\teamcity\createrelease\#{GuideSpecificScreenshotDir}110-build-one-results.png"
