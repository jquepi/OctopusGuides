Feature: Configure an Octopus ASP.NET project
  ...
  Scenario: Save the variables
    ...
    And I scroll down "10000" px
    And I sleep for "7" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}025-octopus-variables-azure-populated.png"
  ...
  Scenario: Add Azure Web App Step
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}035-octopus-azure-add-step.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}040-octopus-azure-search-webapp.png"
    And I sleep for "2" seconds
    ...
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}045-octopus-azure-add-azure-webapp.png"
  ...
  Scenario: Add IIS Step
    ...
    And I highlight outside the "Add Step" button with an offset of "2"
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}035-octopus-add-step.png"
    And I click the "Add Step" button

    And I highlight outside the "Search" text box with an offset of "3"
    And I populate the "Search" text box with "iis"
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}040-octopus-search-iis.png"
    And I sleep for "2" seconds
    And I remove the highlight from the "Search" text box

    And I scroll the "Deploy to IIS" tile into view offset by "-200"
    And I highlight outside the "Deploy to IIS" tile
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}045-octopus-add-iis.png"
  ...
  Scenario: ASP.NET Azure Configure Features
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}046-octopus-azure-enable-conf-features.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}047-octopus-azure-enable-conf-vars.png"
  ...
  Enable the JSON Configuration Variables feature for ASP.NET Core apps
    ...
    And I highlight outside the "Configure features" button
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}046-octopus-enable-conf-features.png"
    And I click the "Configure features" button
    And I remove the highlight from the "Configure features" button
    ...
    And I force click the "Configuration Variables" option
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}047-octopus-enable-conf-vars.png"
    And I click the "OK" button
  ...
  Scenario: Azure Define step
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}050-octopus-azure-step-name.png"
    ...
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}055-octopus-azure-step-role.png"
  ...
  Scenario: Define IIS project
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}050-octopus-step-name.png"
    And I remove the highlight from the "Step Name" text box
    ...
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}055-octopus-step-role.png"
  ...
  Scenario: Select artifactory feed for the iis deployment
    ...
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}060-octopus-step-package-artifactory.png"
  ...
  Scenario: Select built in feed for the iis deployment
    ...
    And I sleep for "2" second
    And I press the escape key from the "Package ID" text box
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}060-octopus-step-package.png"
    And I remove the highlight from the "Package ID" text box
  ...
  Scenario: Select artifactory feed for the azure web app deployment
    ...
    And I sleep for "2" second
    And I press the escape key from the "Package ID" text box
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}060-octopus-step-package-artifactory-azure.png"
    And I remove the highlight from the "Package ID" text box
  ...
  Scenario: Select built in feed for the azure web app deployment
    ...
    And I sleep for "2" second
    And I press the escape key from the "Package ID" text box
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}060-octopus-step-package-azure.png"
    And I remove the highlight from the "Package ID" text box
  ...
  Scenario: Azure Web apps - Continue to define project
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}061-octopus-step-package-artifactory-azure-save.png"
  ...
  Scenario: IIS - Continue to define project
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}065-octopus-step-website-name.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}070-octopus-step-apppool-name.png"
    ...
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}075-octopus-step-remove-binding.png"
    And I click the "Remove binding" button
    And I sleep for "1" second

    And I highlight outside the "Add binding" button with an offset of "2"
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}080-octopus-step-add-binding.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}085-octopus-step-binding-port.png"
    And I click the "OK" button
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}090-octopus-step-auth.png"
  ...
  Configure the JSON Configuration variables section
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\project\#{GuideSpecificScreenshotDir}092-octopus-target-files.png"
