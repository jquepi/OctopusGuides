Feature: Create a Lifecycle in Octopus
  ...
  Scenario: Add dev, test and prod
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}020-lifecycle-name.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}025-lifecycle-add-phase-1.png"
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}030-lifecycle-phase-name-1.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}035-lifecycle-add-environment-1.png"
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}040-lifecycle-select-environment-1.png"
    And I click the "OK" button

    # Test environment
    And I highlight outside the "Add Phase" button with an offset of "2"
    And I scroll the "Add Phase" button into view offset by "-300"
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}045-lifecycle-add-phase-2.png"
    And I click the "Add Phase" button
    And I remove the highlight from the "Add Phase" button
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}050-lifecycle-phase-name-2.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}055-lifecycle-add-environment-2.png"
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}060-lifecycle-select-environment-2.png"
    And I click the "OK" button

    # Prod environment
    And I highlight outside the "Add Phase" button with an offset of "2"
    And I scroll the "Add Phase" button into view offset by "-300"
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}065-lifecycle-add-phase-3.png"
    And I click the "Add Phase" button
    And I remove the highlight from the "Add Phase" button
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}070-lifecycle-phase-name-3.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}075-lifecycle-add-environment-3.png"
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}080-lifecycle-select-environment-3.png"
    And I click the "OK" button

    And I highlight outside the "Save" button
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}090-lifecycle-save.png"
  ...
  Scenario: Assign the lifecycle
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}095-random-quotes-project.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}100-random-quotes-change-lifecycle.png"
    ...
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}105-random-quotes-select-lifecycle.png"
    And I click the "Save" button
  ...
  Scenario: Deploy to the test environment
    ...
    And I highlight outside the "Save" button
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}110-random-quotes-create-release.png"
    ...
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}115-random-quotes-select-test.png"
    And I click the "Test" option

    And I sleep for "3" second
    And I highlight outside the "Deploy" button
    And I sleep for "1" second
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}120-random-quotes-deploy-test.png"
    And I click the "Deploy" button

    And I sleep for "20" seconds
    And I save a screenshot to "C:\screenshots\octopus\lifecycle\#{GuideSpecificScreenshotDir}125-random-quotes-deployed-test.png"
