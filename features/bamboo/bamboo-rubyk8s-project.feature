Feature: Configure Bamboo
  ...
  Scenario: ASP.NET Core Add tasks
    ...
    And I populate the "Task description" text box with "Ruby Test"
  ...
  Scenario: ASP.NET Core Add tasks
    ...
    And I populate the "Repository" text box with "index.docker.io/octopussamples/randomquotesruby:1.0.${bamboo.buildNumber}"
    ...
    And I populate the "Push repository" text box with "octopussamples/randomquotesruby:1.0.${bamboo.buildNumber}"
