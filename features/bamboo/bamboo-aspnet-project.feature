Feature: Configure Bamboo
  ...
  Scenario: Add plugins
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{GuideSpecificScreenshotDir}010-administration.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{GuideSpecificScreenshotDir}030-octopus-addin.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{GuideSpecificScreenshotDir}040-accept.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{GuideSpecificScreenshotDir}050-installed.png"
  ...
  Scenario: Configure Git
    ...
    And I highlight inside the "Administration" button
    And I highlight outside the "Overview" link
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{GuideSpecificScreenshotDir}010-administration.png"
    And I click the "Overview" link

    And I highlight outside the "Server capabilities" link with an offset of "5"
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{GuideSpecificScreenshotDir}020-server-capabilities.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{GuideSpecificScreenshotDir}030-git.png"
    And I click the "Git" link

    And I highlight outside the "Edit" link with an offset of "5"
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{GuideSpecificScreenshotDir}035-edit.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{GuideSpecificScreenshotDir}040-path.png"
  ...
  Scenario: Configure MSBuild
    ...
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{GuideSpecificScreenshotDir}050-msbuild.png"
  ...
  Scenario: Configure Octo CLI
    ...
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{GuideSpecificScreenshotDir}060-octo.png"
    And I click the "Add" button
  ...
  Scenario: Add project
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}010-mybamboo.png"
    And I click the "My Bamboo" link

    And I highlight outside the "Create your first build plan" button
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}020-create-build-plan.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}030-project-name.png"

    And I highlight outside the "Plan name" text box with an offset of "5"
    And I populate the "Plan name" text box with "Website"
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}040-plan-name.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}050-git.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}060-display-name.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}070-repo-url.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}080-test-connection.png"

    And I highlight outside the "Configure plan" button
    And I scroll the "Configure plan" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}090-configure-plan.png"
  ...
  Scenario: ASP.NET Core Add tasks
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}100-add-task.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}110-search.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}120-dotnet-test.png"
    And I remove the highlight from the "Script body" text box

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}130-dotnet-test.png"
    And I click the "Save" button

    # dotnet publish script task
    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}140-add-task.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I populate the "Search" box with "Script"
    And I highlight inside the "Script Tile" element
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}150-search.png"
    And I click the "Script Tile" element
    ...
    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}170-dotnet-publish.png"
    And I click the "Save" button

    # Pack package step
    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}180-add-task.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}200-octo-pack.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}210-octo-pack.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}220-octo-pack.png"
    ...
    And I populate the "Package include paths" text box with "RandomQuotes\RandomQuotes\bin\Release\netcoreapp2.2\publish\"
  ...
  Scenario: ASP.NET Add tasks
    ...
    And I run the following JavaScript:
      ...
      """
    And I sleep for "1" second
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}115-nuget-restore.png"
    And I remove the highlight from the "Script body" text box

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}120-nuget-restore.png"
    And I click the "Save" button

    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}130-add-task.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}140-search.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}145-msbuild.png"
    And I remove the highlight from the "Solution" text box
    And I remove the highlight from the "Options" text box

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}150-msbuild.png"
    And I click the "Save" button

    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}151-add-task.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I populate the "Search" box with "Script"
    And I highlight inside the "Script Tile" element
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}152-search.png"
    And I click the "Script Tile" element
    ...
    And I run the following JavaScript:
      ...
      """
    And I sleep for "1" second
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}153-run-tests.png"
    And I remove the highlight from the "Script body" text box

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}154-run-tests.png"
    And I click the "Save" button
  ...
  Scenario: Add Octopus Push
    ...
    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}160-add-task.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}170-search.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}173-octo-push.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}175-octo-push.png"
  ...
  Scenario: Add Octopus Push
    ...
    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}160-add-task-nuget-push.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I populate the "Search" box with "Script"
    And I highlight inside the "Script Tile" element
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}170-search-nuget-push.png"
    And I click the "Script Tile" element
    ...
    And I run the following JavaScript:
      ...
      """
    And I sleep for "1" second
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}180-nuget-push.png"

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}190-nuget-push.png"
    And I click the "Save" button
    And I stop recording the screen
  ...
  Scenario: Create plan
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{GuideSpecificScreenshotDir}210-build-results.png"
