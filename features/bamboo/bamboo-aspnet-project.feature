Feature: Configure Bamboo
  ...
  Scenario: Add plugins
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{ScreenshotDir}010-administration.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{ScreenshotDir}020-find-apps.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{ScreenshotDir}030-octopus-addin.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{ScreenshotDir}040-accept.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\addins\#{ScreenshotDir}050-installed.png"
  ...
  Scenario: Configure Git
    ...
    And I highlight inside the "Administration" button
    And I highlight outside the "Overview" link
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{ScreenshotDir}010-administration.png"
    And I click the "Overview" link

    And I highlight outside the "Server capabilities" link with an offset of "5"
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{ScreenshotDir}020-server-capabilities.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{ScreenshotDir}030-git.png"
    And I click the "Git" link

    And I highlight outside the "Edit" link with an offset of "5"
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{ScreenshotDir}035-edit.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{ScreenshotDir}040-path.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{ScreenshotDir}050-msbuild.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\executables\#{ScreenshotDir}060-octo.png"
    And I click the "Add" button
  ...
  Scenario: Add project
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}010-mybamboo.png"
    And I click the "My Bamboo" link

    And I highlight outside the "Create your first build plan" button
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}020-create-build-plan.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}030-project-name.png"

    And I highlight outside the "Plan name" text box with an offset of "5"
    And I populate the "Plan name" text box with "Website"
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}040-plan-name.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}050-git.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}060-display-name.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}070-repo-url.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}080-test-connection.png"

    And I highlight outside the "Configure plan" button
    And I scroll the "Configure plan" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}090-configure-plan.png"
  ...
  Scenario: Add tasks
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}100-add-task.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}110-search.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}115-nuget-restore.png"
    And I remove the highlight from the "Script body" text box

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}120-nuget-restore.png"
    And I click the "Save" button

    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}130-add-task.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}140-search.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}145-msbuild.png"
    And I remove the highlight from the "Solution" text box
    And I remove the highlight from the "Options" text box

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}150-msbuild.png"
    And I click the "Save" button

    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}151-add-task.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I populate the "Search" box with "Script"
    And I highlight inside the "Script Tile" element
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}152-search.png"
    And I click the "Script Tile" element
    ...
    And I run the following JavaScript:
      ...
      """
    And I sleep for "1" second
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}153-run-tests.png"
    And I remove the highlight from the "Script body" text box

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}154-run-tests.png"
    And I click the "Save" button
  ...
  Scenario: Add Octopus Push
    ...
    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}160-add-task.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}170-search.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}173-octo-push.png"
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}175-octo-push.png"
    And I remove the highlight from the "Package paths" text box

    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}180-octo-push.png"
    And I click the "Save" button
  ...
  Scenario: Add Octopus Push
    ...
    And I highlight outside the "Add task" button with an offset of "2"
    And I scroll the "Add task" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}160-add-task-nuget-push.png"
    And I click the "Add task" button
    And I remove the highlight from the "Add task" button
    ...
    And I populate the "Search" box with "Script"
    And I highlight inside the "Script Tile" element
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}170-search-nuget-push.png"
    And I click the "Script Tile" element
    ...
    And I run the following JavaScript:
      ...
      """
    And I sleep for "1" second
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}180-nuget-push.png"

    And I highlight outside the "Save" button
    And I scroll the "Save" button into view
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}190-nuget-push.png"
    And I click the "Save" button
    And I stop recording the screen
  ...
  Scenario: Create plan
    ...
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}190-create.png"
    And I click the "Create" button
    And I sleep for "5" seconds

    And I highlight outside the "Build one" link with an offset of "5"
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}200-build-one.png"
    And I click the "Build one" link
    And I click the "Logs" link
    And I sleep for "10" seconds
    And I scroll down "10000" px
    And I sleep for "50" seconds
    And I save a screenshot to "c:\screenshots\bamboo\initialproject\#{ScreenshotDir}210-build-results.png"
