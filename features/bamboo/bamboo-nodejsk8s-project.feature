Feature: Configure Bamboo
  ...
  Scenario: Docker Add tasks
    ...
    And I populate the "Repository" text box with "index.docker.io/octopussamples/randomquotesnodejs:1.0.${bamboo.buildNumber}"
    ...
    And I populate the "Push repository" text box with "octopussamples/randomquotesnodejs:1.0.${bamboo.buildNumber}"
