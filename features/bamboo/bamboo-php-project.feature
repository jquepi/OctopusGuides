Feature: Configure Bamboo
  ...
  Scenario: PHP Add tasks
    ...
    And I populate the "Arguments" text box with "--bootstrap ${bamboo.build.working.directory}/vendor/autoload.php ${bamboo.build.working.directory}/tests/quotetest.php"
